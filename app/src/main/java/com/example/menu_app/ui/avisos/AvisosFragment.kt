...
class AvisosFragments : Fragment(), AdapterView.OnItemSelectedListener {
    var categorias = arrayOf("Factura", "Prestamo", "Deposito", "Banco", "Estudio", "Tarjeta credito", "Targeta de cretido", "Alquiler de casa", "Alquiler de apartamento", "Abono a cuenta" )
